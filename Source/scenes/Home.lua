...
function HomeScreen:setupSprites()
  local viewButton = Button(PLAYDATE_W / 2, PLAYDATE_H - 60, 206, 44, '%HOME_VIEW%')
  ...
  local settingsButton = Button(PLAYDATE_W + 6, -4, 132, 42, '%HOME_SETTINGS%')
